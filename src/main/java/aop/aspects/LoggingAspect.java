...
//    private void returnMagazineFromUmiLibrary(){
//    }
//    @Pointcut("allMethodFromUniLibrary() && !returnMagazineFromUmiLibrary()")
        ...
        if (methodSignature.getName().equals("addBook")) {
            ...
            for (Object obj : arguments) {
                if (obj instanceof Book) {
                    ...
                    System.out.println("книгу в библиотеку добавляєт " + obj);
                }
            }
        }
        System.out.println("beforeAddLoggingAdvice: логування отримати книгу або журнал");
        System.out.println("----------------------------------");
    }
